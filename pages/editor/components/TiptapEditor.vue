<template>
  <div
    id="tiptap"
    class="border border-gray-400 divide-y divide-gray-400 rounded-md"
  >
    ...
    <div class="flex flex-col">
      ...
      <div
        class="py-3 mx-4 text-sm text-right text-gray-500 border-t border-gray-300"
      >
        {{ editorInstance?.storage.characterCount.characters() }} caratteri,
        {{ editorInstance?.storage.characterCount.words() }} parole
      </div>
    </div>
